...
HD_PWD='E:/zsq/work/DSD/hx75_key_7seg/hx75_key_7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hx75_key_7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hx75_key_7seg.tcl
