...
#待测信号接到OV5640的上排从左往右第四个

set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS33 IOB TRUE} [get_ports {cam_data[0]}]
#set_property -dict {PACKAGE_PIN Y6  IOSTANDARD LVCMOS33} [get_ports {P2IO[325]}]
...
# set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS33} [get_ports {clk_fx}]
...
set_property -dict {PACKAGE_PIN H19 IOSTANDARD LVCMOS33} [get_ports clk_fx]
...
set_property -dict {PACKAGE_PIN R6  IOSTANDARD LVCMOS33} [get_ports clk_out1]
set_property -dict {PACKAGE_PIN T6  IOSTANDARD LVCMOS33} [get_ports clk_out2]
