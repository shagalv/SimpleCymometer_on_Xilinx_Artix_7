...
set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports sw4]
...
set_property -dict {PACKAGE_PIN J19 IOSTANDARD LVCMOS33} [get_ports clk_fx]
...
set_input_delay -clock sys_clk 20.000 clk_fx
